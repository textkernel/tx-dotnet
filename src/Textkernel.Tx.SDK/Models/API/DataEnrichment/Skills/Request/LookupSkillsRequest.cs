...
namespace Textkernel.Tx.Models.API.DataEnrichment.Skills.Request
{
    ...
    public class LookupSkillsRequest
    {
        ...
        /// <summary>
        /// The language to use for the output skill descriptions. If not provided, defaults to en. If specified, must be one of the supported <see href="https://sovren.com/technical-specs/latest/rest-api/data-enrichment/overview/#professions-languages">ISO codes</see>.
        /// </summary>
