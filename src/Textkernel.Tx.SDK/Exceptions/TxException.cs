...
namespace Textkernel.Tx
{
    ...
    public class TxException : Exception
    {
        ...
        /// <summary>
        /// The HTTP Status Code of the response. See <see href="https://developer.textkernel.com/tx-platform/v10/overview/#http-status-codes"/>
        /// </summary>
        public HttpStatusCode HttpStatusCode { get; protected set; }

        /// <summary>
        /// The Info.Code of the response. This will indicate what type of error occurred. See <see href="https://developer.textkernel.com/tx-platform/v10/overview/#http-status-codes"/>
        /// </summary>
