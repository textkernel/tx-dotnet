...
namespace Sovren.Models.API.DataEnrichment.Skills.Request
{
    ...
    public class ExtractSkillsRequest
    {
        ...
        /// <summary>
        /// The language of the input text. Must be one of the supported <see href="https://sovren.com/technical-specs/latest/rest-api/data-enrichment-services/overview/#professions-languages">ISO codes</see>.
        /// </summary>
